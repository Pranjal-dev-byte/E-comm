...
module.exports = {
	requireTitle: body('title').trim().isLength({ min: 5, max: 20 }).withMessage('Enter a valid title'),
	requirePrice: body('price').isCurrency().withMessage('Please enter a no. greater than 1'),
